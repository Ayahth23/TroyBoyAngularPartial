import { ɵɵdefineInjectable, Injectable, EventEmitter, Component, ChangeDetectionStrategy, Input, Output, NgModule } from '@angular/core';
...
const DEFAULT_BACKGROUNDFN = (set, sheetSize) => `https://unpkg.com/emoji-datasource-${set}@6.0.0/img/${set}/sheets-256/${sheetSize}.png`;
class EmojiService {
    constructor() {
...
EmojiService.ɵprov = ɵɵdefineInjectable({ factory: function EmojiService_Factory() { return new EmojiService(); }, token: EmojiService, providedIn: "root" });
EmojiService.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiService, [{
        type: Injectable,
...
EmojiComponent.ɵfac = function EmojiComponent_Factory(t) { return new (t || EmojiComponent)(ɵngcc0.ɵɵdirectiveInject(EmojiService)); };
EmojiComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: EmojiComponent, selectors: [["ngx-emoji"]], inputs: { skin: "skin", set: "set", sheetSize: "sheetSize", isNative: "isNative", forceSize: "forceSize", tooltip: "tooltip", size: "size", emoji: "emoji", hideObsolete: "hideObsolete", backgroundImageFn: "backgroundImageFn", fallback: "fallback", sheetRows: "sheetRows", sheetColumns: "sheetColumns", useButton: "useButton", imageUrlFn: "imageUrlFn" }, outputs: { emojiOver: "emojiOver", emojiLeave: "emojiLeave", emojiClick: "emojiClick" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0, decls: 2, vars: 2, consts: [["type", "button", "class", "emoji-mart-emoji", 3, "title", "emoji-mart-emoji-native", "emoji-mart-emoji-custom", "click", "mouseenter", "mouseleave", 4, "ngIf"], ["class", "emoji-mart-emoji", 3, "title", "emoji-mart-emoji-native", "emoji-mart-emoji-custom", "click", "mouseenter", "mouseleave", 4, "ngIf"], ["type", "button", 1, "emoji-mart-emoji", 3, "title", "click", "mouseenter", "mouseleave"], [3, "ngStyle"], [3, "ngIf"], [1, "emoji-mart-emoji", 3, "title", "click", "mouseenter", "mouseleave"]], template: function EmojiComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", !ctx.useButton && ctx.isVisible);
    } }, directives: [ɵngcc1.NgIf, ɵngcc1.NgStyle], encapsulation: 2, changeDetection: 0 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiComponent, [{
        type: Component,
        args: [{
                selector: 'ngx-emoji',
                template: `
  ...
  `,
    ...
    }], function () { return [{ type: EmojiService }]; }, { skin: [{
            type: Input
        }], set: [{
            type: Input
        }], sheetSize: [{
...
EmojiModule.ɵfac = function EmojiModule_Factory(t) { return new (t || EmojiModule)(); };
EmojiModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: EmojiModule });
EmojiModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(EmojiModule, { declarations: function () { return [EmojiComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [EmojiComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiModule, [{
        type: NgModule,
        args: [{
