(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ctrl = global.ctrl || {}, global.ctrl['ngx-emoji-mart'] = global.ctrl['ngx-emoji-mart'] || {}, global.ctrl['ngx-emoji-mart']['ngx-emoji'] = {}), global.ng.core, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var DEFAULT_BACKGROUNDFN = function (set, sheetSize) { return "https://unpkg.com/emoji-datasource-" + set + "@6.0.0/img/" + set + "/sheets-256/" + sheetSize + ".png"; };
    var EmojiService = /** @class */ (function () {
        ...
        EmojiService.prototype.getData = function (emoji, skin, set) {
            ...
            if (hasSkinVariations && skin && skin > 1 && set) {
                ...
                var variationData = emojiData.skinVariations.find(function (n) { return n.unified.includes(skinKey_1); });
        ...
        EmojiService.prototype.emojiSpriteStyles = function (sheet, set, size, sheetSize, sheetRows, backgroundImageFn, sheetColumns, url) {
            ...
            if (sheetColumns === void 0) { sheetColumns = 58; }
            var hasImageUrl = !!url;
    ...
    EmojiComponent.propDecorators = {
        ...
        forceSize: [{ type: i0.Input }],
        tooltip: [{ type: i0.Input }],
        size: [{ type: i0.Input }],
        emoji: [{ type: i0.Input }],
        fallback: [{ type: i0.Input }],
        hideObsolete: [{ type: i0.Input }],
        sheetRows: [{ type: i0.Input }],
        sheetColumns: [{ type: i0.Input }],
